...
export default function PromoPayPage() {
  ...
  const title = searchParams.get('title') || 'Promo'
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 px-4 py-12">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-indigo-900">Complete Your Payment</h1>
          <p className="text-gray-600 text-sm mt-1">Pay via GCash and upload your proof of payment.</p>
        </div>
